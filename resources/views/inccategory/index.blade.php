    ...
    <div class="py-12">
        ...
        <div class=" mx-auto sm:px-6 lg:px-8">
            <div class="d-flex justify-content-between">
                ...
                <a class="btn btn-light-green" href="{{ route('inccategory.create') }}"><i class="fa-solid fa-plus pe-1"></i>Add Category</a>
            </div>
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg mt-3">
                <div class=" mx-auto px-4 py-4">
                    ...
                    <div class="d-flex flex-row">
                        ...
                        <form id="deleteSelectedForm" action="{{ route('inccategory.deleteSelected') }}" method="POST">
                            @csrf
                            @method('DELETE')
                        ...
                        <form action="{{ route('inccategory.index') }}" method="GET" class="flex-fill">
                    ...
                    <table class="w-full mt-4 table">
                        ...
                        <tbody>
                            @include('inccategory.table_body')
                        </tbody>
                    </table>
