    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="d-flex justify-content-between">
                <h3 class="text-2xl">Announcements</h3>
            </div>
                ...
                <div class="container mx-auto px-4 py-4">
                    ...
                    <form action="{{ route('announcement.store') }}" method="POST">
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-4">
                                <label for="date_announcement" class="fw-bold">Date of announcement</label>
                                <div class="input-group log-event"id="date_announcement" data-td-target-input="nearest" data-td-target-toggle="nearest">
                                    <input id="date_announcementInput"  name="date_announcement" type="text" class="form-control" data-td-target="#date_announcement" value="{{ old('date_announcement') }}"/>
                                ...
                                <div class="input-group date" id="datepicker">
                                    <input type="text" class="form-control" name="date_announcement"  value="{{ old('date_announcement') }}" id="date_announcement" required/>
