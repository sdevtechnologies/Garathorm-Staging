    ...
    <div class="py-12">
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="d-flex justify-content-between">
                ...
                <a class="btn btn-light-green" href="{{ route('announcement.create') }}"><i class="fa-solid fa-plus pe-1"></i>Add announcements and Announcements</a>
            </div>
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg mt-3">
                <div class="container mx-auto px-4 py-4">
                    ...
                    <div class="d-flex flex-row">
                        ...
                        <form action="{{ route('announcement.index') }}" method="GET" class="flex-fill">
