            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg mt-3">
                <div class="container mx-auto px-4 py-4">
                    <div class="text-right">
                        <a href="{{route('laws.index')}}" class="btn btn-danger"><i class="fa-solid fa-xmark pe-2"></i>Close</a>
                    </div>
                    @if ($errors->any())
                        <div class="mt-2">
                    ...
                    <form action="{{ route('laws.update',$law) }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="title"  value="{{old('title') ? old('title') : $law->title}}" placeholder="Title" id="title" class="form-control" required>
                        </div>
                        <div class="row mb-4">
                            <div class="col-md-3">
                                ...
                                <select name="category" id="category" class="form-control" style="width: 100%" required>
                                    ...
                                    @foreach ($categories as $category)
                                        <option value="{{$category->id}}" <?php if (old('category')){
                                            ...
                                            echo ($law->category_id==$category->id ? "selected" : "");
                                        } 
                                ...
                                <select name="publisher" id="publisher" class="form-control" style="width: 100%" required>
                                    ...
                                    @foreach ($publishers as $publisher)
                                        <option value="{{$publisher->id}}" <?php if (old('publisher')){
                                            ...
                                            echo ($law->publisher_id==$publisher->id ? "selected" : "");
                                        } 
                            ...
                            <div class="col-md-2">
                                <label for="date_incident" class="fw-bold"><span class="text-danger">*</span>Date Published</label>
                                <div class="input-group log-event"id="date_incident" data-td-target-input="nearest" data-td-target-toggle="nearest">
                                    <input id="date_incidentInput"  name="date_published" type="text" class="form-control" data-td-target="#date_incident" value="{{old('date_published') ? old('date_published') : Carbon\Carbon::parse($law->date_published)->format('d/M/Y')}}"/>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="d-flex flex-row w-full">
                                <div class="w-full">
                                    <input type="text" name="url_link" value="{{old('url_link') ? old('url_link') : $law->url_link}}" id="url" placeholder="https://url.com" class="form-control" required>
                                </div>
                                <div class="ml-2">
                        ...
                        <div class="mb-4">
                            ...
                            <div class="d-flex flex-row w-full">
                                <div class="w-full">
                                    <textarea name="description" rows="7" id="description"  placeholder="Add a short description" class="form-control h-full" required>{{old('description') ? old('description') : $law->description}}</textarea>
                                </div>
                                <div class="ml-2">
