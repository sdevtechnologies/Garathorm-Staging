                    ...
                    <form action="{{ route('laws.store') }}" method="POST">
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-3">
                                ...
                                <select name="relatedcategory[]" id="relatedcategory" class="form-control" multiple="multiple" style="width:100%;">
                            ...
                            <div class="col-md-2">
                                ...
                                <div class="input-group log-event"id="date_incident" data-td-target-input="nearest" data-td-target-toggle="nearest">
                                    <input id="date_incidentInput"  name="date_published" type="text" class="form-control" data-td-target="#date_incident" value="{{ old('date_published') }}"/>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="d-flex flex-row w-full pasteContainer">
                                <div class="w-full inputDiv">
                                    <textarea name="description" rows="7" id="description"  placeholder="Add a short description" class="form-control h-full" required>{{ old('description') }}</textarea>
                                </div>
                                <div class="ml-2">
                                ...
                                <div class="ml-1">
                                    ...
                                    <!--<textarea name="description" id="description" rows="3" class="border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm w-full" required></textarea>-->
                        </div>
