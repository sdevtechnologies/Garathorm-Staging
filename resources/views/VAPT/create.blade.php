                        ...
                        <div class="row mb-4">
                            <div class="col-md-6">
                                ...
                                <select name="category" id="category" class="form-control" required>
                                    ...
                                    <option value="DNS" {{ old('category')=="DNS" ? "selected" : "" }}>DNS</option>
                                    <option value="HIPAA" {{ old('category')=="HIPAA" ? "selected" : "" }}>HIPAA</option>
                                    <option value="ISO" {{ old('category')=="ISO" ? "selected" : "" }}>ISO</option>
                                    <option value="IAM" {{ old('category')=="IAM" ? "selected" : "" }}>IAM</option>
                                    <option value="PCI" {{ old('category')=="PCI" ? "selected" : "" }}>PCI</option>
                                    <option value="GDPR" {{ old('category')=="GDPR" ? "selected" : "" }}>GDPR</option>
                                    <option value="CII" {{ old('category')=="CII" ? "selected" : "" }}>CII</option>   
                                </select>
                            </div>
                            <div class="col-md-6">
