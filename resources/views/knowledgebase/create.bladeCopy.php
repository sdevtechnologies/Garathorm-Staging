                ...
                <div class="container mx-auto px-4 py-4">
                    ...
                    <form action="{{ route('knowledgebase.store') }}" method="POST">
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-4">
                                <label for="date_knowledgebase" class="fw-bold">Date of knowledgebase</label>
                                ...
                                <div class="input-group date" id="datepicker">
                                    <input type="text" class="form-control" name="date_knowledgebase"  value="{{ old('date_knowledgebase') }}" id="date_knowledgebase" required/>
